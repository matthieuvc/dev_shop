...
webdev3 = Webdev.new(service_type: "Mobile App Development", price: 250, experience_year: 7, availability: "1Oh/week", description: "Proficient in optimizing websites for speed and performance.")
webdev3.user = user3
webdev3.photo.attach(io: File.open('app/assets/images/gabrielle.jpeg'), filename: 'gabrielle.jpeg')
webdev3.save!

webdev4 = Webdev.new(service_type: "UI/UX Design", price: 800, experience_year: 2, availability: "1Oh/week", description: "Capable of troubleshooting and debugging web applications efficiently.")
webdev4.user = user4
webdev4.photo.attach(io: File.open('app/assets/images/quentin.jpeg'), filename: 'quentin.jpeg')
webdev4.save!

webdev5 = Webdev.new(service_type: "Front-end Development", price: 200, experience_year: 4, availability: "1Oh/week", description: "Familiar with UX/UI principles to enhance user experience.")
webdev5.user = user5
webdev5.photo.attach(io: File.open('app/assets/images/thomas.png'), filename: 'thomas.png')
webdev5.save!

webdev6 = Webdev.new(service_type: "Back-end Development", price: 300, experience_year: 6, availability: "1Oh/week", description: "Knowledgeable in version control systems like Git for collaboration.
  ")
webdev6.user = user6
webdev6.photo.attach(io: File.open('app/assets/images/gabriella.jpeg'), filename: 'gabriella.jpeg')
webdev6.save!

webdev7 = Webdev.new(service_type: "WordPress Development", price: 350, experience_year: 3, availability: "1Oh/week", description: "Strong understanding of database management with SQL or MongoDB.")
webdev7.user = user7
webdev7.photo.attach(io: File.open('app/assets/images/momo.jpeg'), filename: 'momo.jpeg')
webdev7.save!

webdev8 = Webdev.new(service_type: "Custom Web Application Development", price: 2, experience_year: 8, availability: "1Oh/week", description: "Experienced in back-end development using Node.js or Django.")
webdev8.user = user8
webdev8.photo.attach(io: File.open('app/assets/images/jose.png'), filename: 'jose.png')
webdev8.save!

webdev9 = Webdev.new(service_type: "Graphic Design", price: 400, experience_year: 8, availability: "1Oh/week", description: "Skilled in front-end frameworks like React, Angular, or Vue.
  ")
webdev9.user = user9
webdev9.photo.attach(io: File.open('app/assets/images/junior.jpeg'), filename: 'junior.jpeg')
webdev9.save!

webdev10 = Webdev.new(service_type: "SEO Optimization", price: 550, experience_year: 1, availability: "1Oh/week", description:"Proficient in building responsive and user-friendly websites.
  ")
webdev10.user = user10
webdev10.photo.attach(io: File.open('app/assets/images/pedro.jpeg'), filename: 'pedro.jpeg')
webdev10.save!

webdev11 = Webdev.new(service_type: "Web Dev Teach", price: 550, experience_year: 5, availability: "1Oh/week", description:"Expert in HTML, CSS, JavaScript for stunning web designs.")
webdev11.user = user11
webdev11.photo.attach(io: File.open('app/assets/images/cass.jpeg'), filename: 'cass.jpeg')
webdev11.save!

webdev1 = Webdev.new(service_type: "Website Development", price: 180, experience_year: 5, availability: "1Oh/week", description: "Proficient in optimizing websites for speed and performance.")
webdev1.user = user1
webdev1.photo.attach(io: File.open('app/assets/images/matthieu.jpeg'), filename: 'matthieu.jpeg')
webdev1.save!

webdev2 = Webdev.new(service_type: "E-commerce Development", price: 150, experience_year: 3, availability: "1Oh/week", description:"Dedicated to continuous learning and staying updated with emerging technologies.")
webdev2.user = user1
